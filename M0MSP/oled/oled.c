...
{
DL_GPIO_clearPins(OLED_RST_PORT,OLED_RST_PIN_25_PIN);
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
...
{
 DL_GPIO_setPins(OLED_RST_PORT,OLED_RST_PIN_25_PIN); 
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
...
DL_GPIO_clearPins(OLED_DC_PORT,OLED_DC_PIN_26_PIN); //PDout(11)=0   //DC
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
...
{
 DL_GPIO_setPins(OLED_DC_PORT,OLED_DC_PIN_26_PIN) ; //PDout(11)=1   //DC
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
...
DL_GPIO_clearPins(OLED_SCL_PORT,OLED_SCL_PIN_28_PIN); //PDout(14)=0   //SCL
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
...
{
DL_GPIO_setPins(OLED_SCL_PORT,OLED_SCL_PIN_28_PIN); //PDout(14)=1   //SCL
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
...
{
DL_GPIO_clearPins(OLED_SDA_PORT,OLED_SDA_PIN_31_PIN); //PDout(13)=0   //SDA
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
...
{
DL_GPIO_setPins(OLED_SDA_PORT,OLED_SDA_PIN_31_PIN); //PDout(13)=1   //SDA
	 __asm__("nop");
	 __asm__("nop");
		 __asm__("nop");
	 __asm__("nop");
